...
SECRET_KEY = 'django-insecure-)5dk4i^8v%8gl)bmer@&)=)8exd37(+7w&9io^-7j9#9!6da%-'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'image_recognition_app' / 'static']

MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'image_recognition_app' / 'media'